...
## 3.4.4 Submitting your fix

Once you are ready with the fix, you can submit your fix to the Go Team by means of [Github pull requests](https://help.github.com/articles/using-pull-requests). Our approval process can be read on our [website](http://go.cd).

## 3.4.5 Updating Github Issues
