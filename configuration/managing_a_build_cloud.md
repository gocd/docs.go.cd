...
To permanently remove an agent from Go's configuration, you can use the [agent api](https://api.gocd.io/#agents) or delete from the agents tab. The agent must be disabled before it can be deleted
