...
Go uses XML based configuration to define the dependencies. Being a web-application, the `web.xml` defines a ContextLoaderListener which would create an ApplicationContext, the location for which is defined as:
