...
[GoCD APIs](https://api.go.cd/current/), [yagocd](https://github.com/grundic/yagocd),
...
1. Install the [JSON config plugin](https://github.com/tomzo/gocd-json-config-plugin/releases) as mentioned in the
   [Plugin User Guide](https://docs.go.cd/current/extension_points/plugin_user_guide.html#installing-and-uninstalling-of-plugins).
