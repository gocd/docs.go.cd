...
* [Writing Go Plugins](writing_go_plugins/overview.md)
    ...
    * [Task plugins](writing_go_plugins/task/task_plugin_overview.md)
      * [Task plugin - Java API based (Deprecated)](writing_go_plugins/task/writing_go_task_plugins.md)
      * [Task plugin - JSON API - Message based](writing_go_plugins/task/json_message_based_task_extension.md)
