...
> **Since release 14.2, the release notes for Go are available on the [go.cd website](https://www.gocd.io/releases/#latest).**
...
-   [User Delete API:](https://api.gocd.io/#users) A new API using which you can delete a disabled user.
...
-   [Additional agent APIs](https://api.gocd.io/#agents): Go now provides an API to list details of all agents and another API to delete disabled agents.
...
-   Get the list of [scheduled jobs](https://api.gocd.io/current/#pipelines) using API.
...
-   [Agent API - Enable and disable an agent](https://api.gocd.io/#agents)
...
-   Go uses pipeline counter instead of label in [artifacts](https://api.gocd.io/current/#artifacts) and [properties](https://api.gocd.io/current/#properties) Restful urls.
...
-   Refactored Go API and remove some calls. See the [Go API topic](https://api.gocd.io/) for more details.
