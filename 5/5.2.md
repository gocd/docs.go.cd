...
## <a name="confugiration-management"></a>5.2.1 Configuration Management
...
### <a name="xsd-and-xml"></a>5.2.1.1 XSD & XML
...
### <a name="schema-migration"></a>5.2.1.2 Schema Migration
...
### <a name="config-repository"></a>5.2.1.3 Config Repository
...
### <a name="config-merge"></a>5.2.1.4 Config Merge
...
### <a name="config-diff"></a>5.2.1.5 Config Diff
...
## <a name="database-management"></a>5.2.2 Database Management
...
### <a name="schema"></a>5.2.2.1 Schema
...
### <a name="database-migration"></a>5.2.2.2 Database migrations
...
### <a name="backup"></a>5.2.2.3 Backup
...
## <a name="mdu"></a>5.2.3 Material update sub-system (MDU)
...
## <a name="interface-architecture"></a>5.2.10 User Interface Architecture
